        ...
        <div className="container">
          <div className="cs_footer_top">
            <div className="cs_footer_top_content_list">
              <div className="cs_brand wow zoomIn">
                 <Image src="/assets/img/footer_logo.svg" alt="img" width={212} height={38}   />
              </div>
            ...
            <div className="cs_footer_row">
              ...
              <div className="cs_footer_links_wrapper">
                ...
                <div className="cs_footer_widget">
                  ...
                  <ul className="cs_footer_menu cs_mp_0">
                    <li><Link href="/service/service-details" aria-label="Page link">Digital marketing</Link></li>
                    <li><Link href="/service/service-details" aria-label="Page link">Web development</Link></li>
                    <li><Link href="/service/service-details" aria-label="Page link">SEO optimized</Link></li>
                    <li><Link href="/service/service-details" aria-label="Page link">App Development</Link></li>
                    <li><Link href="/service/service-details" aria-label="Page link">Email Marketing</Link></li>
                  </ul>
                </div>
                <div className="cs_footer_widget">
          ...
          <div className="cs_footer_bottom cs_white_color_2">
            <div className="cs_footer_copyright cs_center">&copy; All Copyright 2025 by
              <a href="#" aria-label="Site link"> Digitom</a>
            </div>
          </div>
        </div>
      </footer>
